...
## Overview
Custom Drupal 10 module for event registration via an interactive form. Includes admin event configuration, AJAX-based dependent dropdowns, validation, database storage, email notifications, and admin listing with CSV export.
